...
export default function DataTable() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BSMS_BACKEND_URL}/api/User/manager`,
        {
          method: "GET",
        }
      );
  ...
  const deleteUser = async (userId) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BSMS_BACKEND_URL}/api/User/remove/${userId}`,
        {
          method: "POST",
        }
      );
  ...
  const editUser = async (user) => {
    if (!errorsf.firstName && !errorsf.lastName && !errorsf.status) {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BSMS_BACKEND_URL}/api/User/update/${user.id}`,
          {
            method: "POST",
            headers: {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BSMS_BACKEND_URL}/api/User/brokerAdminRegister`,
        {
          method: "POST",
          body: formDataToSend,
        }
